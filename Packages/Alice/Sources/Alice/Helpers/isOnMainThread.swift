...
/**
Allows us to determine whether the function is running on the main thread or on a background thread, and log a brief
 description of the code on the console.
