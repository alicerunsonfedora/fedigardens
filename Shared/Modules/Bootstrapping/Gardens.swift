...
struct Shout: App {
    ...
    /// corresponding to a reply action, such as `gardens://create?reply_id=XXX` where `XXX` is the ID of the status
...
//                }
                .onAppear {
                    // Set the app's URL prefix to match our URL scheme. This should prevent Gardens from
